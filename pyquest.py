...
def main():
    ...
    F.set_borders(set([A]))
    P1 = {'name':'P1', 'gold':1000, 'force': 500, 'is_human':False, 'A':'P1', 'B':'P2', 'C':'P3', 'D':'WILD', 'P2':{'name':'P2', 'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500, 'P1': {'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500}, 'P3': {'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500}},'P3':{'name':'P3', 'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500, 'P1':{'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500},'P2':{'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500}}}
    P2 = {'name':'P2', 'gold':1000, 'force': 500, 'is_human':False, 'A':'P1', 'B':'P2', 'C':'P3', 'D':'WILD', 'P1':{'name':'P1', 'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500, 'P2': {'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500}, 'P3': {'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500}},'P3':{'name':'P3', 'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500, 'P1':{'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500},'P2':{'Trust':'Low', 'Diplomacy':'Neutral', 'gold':1000, 'force': 500}}}
